...
describe('resource screener', () => {
  test('get', async () => {
    const responsePromise = client.stocks.screener.get();
  ...
  test('get: request options instead of params are passed correctly', async () => {
    ...
    await expect(client.stocks.screener.get({ path: '/_stainless_unknown_path' })).rejects.toThrow(
