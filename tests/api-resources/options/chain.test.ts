...
describe('resource chain', () => {
  test('retrieve', async () => {
    const responsePromise = client.options.chain.retrieve('symbol');
  ...
  test('retrieve: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      client.options.chain.retrieve('symbol', { path: '/_stainless_unknown_path' }),
