...
describe('resource insiderTrades', () => {
  test('retrieve', async () => {
    const responsePromise = client.insiderTrades.retrieve();
  ...
  test('retrieve: request options instead of params are passed correctly', async () => {
    ...
    await expect(client.insiderTrades.retrieve({ path: '/_stainless_unknown_path' })).rejects.toThrow(
