...
describe('instantiate client', () => {
  ...
  describe('baseUrl', () => {
    ...
    afterEach(() => {
      process.env['UNUSUALWHALES_BASE_URL'] = undefined;
    });

    test('explicit option', () => {
      const client = new Unusualwhales({ baseURL: 'https://example.com', apiKey: 'My API Key' });
      expect(client.baseURL).toEqual('https://example.com');
    });

    test('env variable', () => {
      process.env['UNUSUALWHALES_BASE_URL'] = 'https://example.com/from_env';
    ...
    test('empty env variable', () => {
      ...
      const client = new Unusualwhales({ apiKey: 'My API Key' });
      expect(client.baseURL).toEqual('https://api.unusualwhales.com/api');
    });
  ...
  test('maxRetries option is correctly set', () => {
    const client = new Unusualwhales({ maxRetries: 4, apiKey: 'My API Key' });
    expect(client.maxRetries).toEqual(4);

    // default
    const client2 = new Unusualwhales({ apiKey: 'My API Key' });
    expect(client2.maxRetries).toEqual(2);
  });

  test('with environment variable arguments', () => {
    // set options via env var
    process.env['API_KEY_AUTH'] = 'My API Key';
    const client = new Unusualwhales();
  ...
  test('with overriden environment variable arguments', () => {
    // set options via env var
    process.env['API_KEY_AUTH'] = 'another My API Key';
    const client = new Unusualwhales({ apiKey: 'My API Key' });
    expect(client.apiKey).toBe('My API Key');
  });
});
...
describe('retries', () => {
  test('retry on timeout', async () => {
    ...
    const client = new Unusualwhales({ apiKey: 'My API Key', timeout: 10, fetch: testFetch });
  ...
  test('retry count header', async () => {
    ...
    const client = new Unusualwhales({ apiKey: 'My API Key', fetch: testFetch, maxRetries: 4 });
  ...
  test('retry on 429 with retry-after', async () => {
    ...
    const client = new Unusualwhales({ apiKey: 'My API Key', fetch: testFetch });
